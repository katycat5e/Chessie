    ...
    public static class PieceSquareTables
    {
        public static int Evaluate(LocatedPiece piece)
        {
            ...
            int[] table = (piece.Piece & PieceType.PieceMask) switch
            {
                ...
                PieceType.King => KingEarlyTable,
                _ => throw new ArgumentException("Uhh what is that piece? " + piece.ToString())
            };
        ...
        public static readonly int[] KingEarlyTable = {
        ...
        public static readonly int[] KingLateTable = {
